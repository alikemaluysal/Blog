...
public class UserConfiguration : IEntityTypeConfiguration<User>
{
    public void Configure(EntityTypeBuilder<User> builder)
    {
        ...
        //builder.HasMany(u => u.Comments).WithOne(c => c.User).OnDelete(DeleteBehavior.NoAction);
        //builder.HasMany(u => u.Posts).WithOne(c => c.User).OnDelete(DeleteBehavior.NoAction);
